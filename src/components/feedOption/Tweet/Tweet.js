  ...
  return (
    <div className="tweet-container">
      <div className="profile-photo-div">
        <img  onClick={profile} src={props.data.authorImg} alt="" />
      </div>
...
{/* <------------------------------------------------------> */}
      ...
      <div className="content-box">
         ...
         <div className="header">
           <a onClick={profile} ><span className="fw-bold">{props.data.authorName}</span></a>
            &nbsp;
            <svg fill="cornflowerblue" width="18px" height="18px"viewBox="0 0 24 24"aria-label="Verified account"role="img" class="r-1cvl2hr r-4qtqp9 r-yyyyoo r-1xvli5t r-9cviqr r-f9ja8p r-og9te1 r-bnwqim r-1plcrui r-lrvibr">
            ...
            &nbsp;
            <span className="fs-6">{props.data.UserName}</span>
            &nbsp;
    ...
    <div className="tweet-text">{props.data.text}</div>
        ...
        <div className="tweet-footer">
          <div className='coment'>
            <svg width="18px" height="18px" viewBox="0 0 24 24" aria-hidden="true" class="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1hdv0qi">
        ...
        <div className='like' onClick={()=>props.Like(props.data.id)}>
          ...
          <div className='share'>
            ...
            <svg
              width="18px"height="18px"viewBox="0 0 24 24"aria-hidden="true"class="r-4qtqp9 r-yyyyoo r-1xvli5t r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1hdv0qi" >
